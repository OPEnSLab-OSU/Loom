...
arduino_setup()
{
	...
	echo "boardsmanager.additional.urls=https://adafruit.github.io/arduino-board-index/package_adafruit_index.json,https://github.com/OPEnSLab-OSU/Loom_Auxiliary/raw/master/package_loom_index.json" >> usr/Library/Arduino15/preferences.txt
