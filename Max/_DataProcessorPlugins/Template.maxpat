...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 671.0, 515.0, 173.0, 33.0 ],
					"style" : "",
					"text" : "Do Further OSC Route Handling Here"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 671.0, 28.0, 173.0, 33.0 ],
					"style" : "",
					"text" : "Put Custom Interface Elements Here"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.475067, 229.333328, 168.0, 74.0 ],
					"style" : "",
					"text" : "Device commands from interface should be prepended with handling JS function name and converge here"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.341705, 639.0, 23.0, 22.0 ],
					"style" : "",
					"text" : "t s"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.475067, 613.0, 165.0, 74.0 ],
					"style" : "",
					"text" : "All the prepends should then converge here which connects to the 'JS commands in' inlet of Device Targeting"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 521.166687, 59.333336, 4.0, 604.166626 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.475067, 522.166687, 165.0, 33.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.475067, 412.666687, 168.0, 60.0 ],
					"style" : "",
					"text" : "Custom Route Message from Device / Subnet / Global\nAdd as space seperated terms"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.341705, 488.666687, 68.0, 22.0 ],
					"style" : "",
					"text" : "OSC-route"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 303.341705, 572.666687, 117.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.341705, 255.333328, 23.0, 22.0 ],
					"style" : "",
					"text" : "t s"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 2 ],
					"midpoints" : [ 284.633362, 201.0, 103.0, 201.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 0 ],
					"midpoints" : [ 70.666672, 146.291672, 37.5, 146.291672 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-6", 3 ],
					"midpoints" : [ 409.133362, 216.0, 135.75, 216.0 ],
					"source" : [ "obj-58", 0 ]
				}
