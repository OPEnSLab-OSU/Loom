...
Adafruit_NeoPixel pixels0 = Adafruit_NeoPixel(1, pin0, NEO_GRB + NEO_KHZ800);
//Adafruit_NeoPixel pixels1 = Adafruit_NeoPixel(1, pin1, NEO_GRB + NEO_KHZ800);
Adafruit_NeoPixel pixels2 = Adafruit_NeoPixel(2, pin2, NEO_GRB + NEO_KHZ800);
...
void setColor(OSCMessage &msg, int addrOffset){
  pixelNum = msg.getInt(0);
  char color[1];
  msg.getString(1, color, 1);
...
pixels0.setPixelColor(0, pixels0.Color(val, 50, 200));
pixels0.show();
...
//Serial.println(x);
//
//pixels0.setPixelColor(0, pixels1.Color(x, 50, 200));
//pixels0.show();
...
//      pixels1.setPixelColor(0, pixels1.Color(100, 100, 100));
//      pixels1.show();

//pixels1.setPixelColor(0, pixels1.Color(redVal, greenVal, blueVal));


      bndl.route("/LOOM/Ishield0/Port0/Neopixel", setColor);
      bndl.route("/LOOM/Ishield0/Port1/Neopixel", setColor);
      bndl.route("/LOOM/Ishield0/Port2/Neopixel", setColor);

//      if (strstr(addressString, "Port0")){
//        Serial.println("IN 0");
//        pixels0.setPixelColor(pixelNum, pixels0.Color((redVal > 255) ? 255 : redVal, (greenVal > 255) ? 255 : greenVal, (blueVal > 255) ? 255: blueVal));
//        pixels0.show();
//      }
//      if (strstr(addressString, "Port1")){
//        Serial.println("IN 1");
//        pixels1.setPixelColor(pixelNum, pixels1.Color((redVal > 255) ? 255 : redVal, (greenVal > 255) ? 255 : greenVal, (blueVal > 255) ? 255: blueVal));
//        pixels1.show();
//      }
      if (strstr(addressString, "Port2")){
        Serial.println("IN 2");
//        if (pixelNum == 0){
//          Serial.println("PIXEL 0");
//          pixels2.setPixelColor(0, pixels2.Color((redVal > 255) ? 255 : redVal, (greenVal > 255) ? 255 : greenVal, (blueVal > 255) ? 255: blueVal));
//        }
//        if (pixelNum == 1){ 
//          Serial.println("PIXEL 1");
          pixels2.setPixelColor(pixelNum, pixels2.Color((redVal > 255) ? 255 : redVal, (greenVal > 255) ? 255 : greenVal, (blueVal > 255) ? 255: blueVal));
//        }
        pixels2.show();
      }
#ifdef is_i2c
