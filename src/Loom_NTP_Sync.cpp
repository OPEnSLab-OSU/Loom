...
bool LoomNTPSync::LoomNTPSync_Registered = (Flags::InternetWiFi || Flags::InternetEthernet || Flags::InternetAll) ? Registry<LoomModule>::add<LoomNTPSync>("LoomNTPSync") : false;
