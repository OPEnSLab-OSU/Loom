...
///////////////////////////////////////////////////////////////////////////////
void MaxSub::add_config(JsonObject json)
{
...
///////////////////////////////////////////////////////////////////////////////
bool MaxSub::goto_client_mode(const char* ssid, const char* pass)
{
	// Make sure WiFi mode is up to date
	get_wifi_mode(); 
...
///////////////////////////////////////////////////////////////////////////////
MaxSub::WiFiMode MaxSub::get_wifi_mode() 
{
	wifi_mode = WiFiMode::INVALID;
