...
Loom_Interrupt_Manager::Loom_Interrupt_Manager(
        ...
        : LoomModule(manager, "InterruptManager", Type::Interrupt_Manager), RTC_Inst(RTC_Inst) {
...
void Loom_Interrupt_Manager::print_config() const {
    ...
    for (auto i = 0; i < InteruptRange; i++) {
        LPrint("\t\tPin ", i, " | ISR: ",
               (int_settings[i].run_type == ISR_Type::IMMEDIATE) ? "Immediate" : "Check Flag");
        LPrintln(" | Type: ", interrupt_type_to_string(int_settings[i].type), " | ",
                 (int_settings[i].enabled) ? "Enabled" : "Disabled");
...
///////////////////////////////////////////////////////////////////////////////
void Loom_Interrupt_Manager::register_ISR(const uint32_t pin, const ISRFuncPtr ISR, const uint32_t signal_type,
...
void Loom_Interrupt_Manager::interrupt_reset(const uint32_t pin) {
    ...
    if (int_settings[pin].ISR != nullptr) {
        // Attach interrupt with specified type
        attachInterrupt(digitalPinToInterrupt(pin), int_settings[pin].ISR,
                        (int_settings[pin].type < 5) ? int_settings[pin].type : 0);
    }
}
...
///////////////////////////////////////////////////////////////////////////////
bool Loom_Interrupt_Manager::RTC_alarm_duration(const uint8_t days, const uint8_t hours, const uint8_t minutes,
...
///////////////////////////////////////////////////////////////////////////////
bool
Loom_Interrupt_Manager::RTC_alarm_duration_from_last(const uint8_t days, const uint8_t hours, const uint8_t minutes,
                                                     const uint8_t seconds) {
...
///////////////////////////////////////////////////////////////////////////////
void Loom_Interrupt_Manager::register_timer(const uint8_t timer_num, const unsigned long duration, const ISRFuncPtr ISR,
                                            const bool repeat) {
...
///////////////////////////////////////////////////////////////////////////////
void Loom_Interrupt_Manager::register_internal_timer(const uint duration, const ISRFuncPtr ISR, const bool repeat,
                                                     const ISR_Type run_type) {
