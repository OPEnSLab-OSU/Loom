...
bool Loom_MaxPub::Loom_MaxPub_Registered = (Flags::InternetWiFi || Flags::InternetEthernet || Flags::InternetAll) ? Registry<LoomModule>::addNoDefault<Loom_MaxPub>("Loom_MaxPub") : false;
