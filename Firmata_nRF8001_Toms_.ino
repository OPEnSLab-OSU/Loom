// This code was modified from adafruit.com
// Written by Tom DeBell for use in the OPEnS Lab 
...
/*==============================================================================
 * FUNCTIONS, This sketch acts to control pin in and outs based of user input in app interface
 *============================================================================*/
