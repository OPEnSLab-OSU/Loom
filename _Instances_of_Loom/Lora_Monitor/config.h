...
#define CHANNEL          9		// Channel to use. Set to 1-8 for channels A-H, respectively. Alternatively can define to -1 to used advanced option INIT_INST
...
#define CUSTOM_NAME "PingMobile"	// This is only used if Auto_name is set to be 0
...
// --- LoRa Options ---
	...
	#else // is node
		#define LORA_HUB_ADDRESS  0			// 10 CLIENT_ADDRESSes belong to each SERVER_ADDRESS, 
